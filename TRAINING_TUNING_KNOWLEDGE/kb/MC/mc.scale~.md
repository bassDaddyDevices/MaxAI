...
type: mc
name: "mc.scale~"
summary: "Map an input range of signal values to an output range  (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.scale~/"
package: "MC"
see_also: ["scale", "clip", "clip~"]
---
# mc.scale~

Map an input range of signal values to an output range (multichannel)

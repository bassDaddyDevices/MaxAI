...
type: mc
name: "mc.gen~"
summary: "Generate native audio signal processing routines (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.gen~/"
package: "MC"
see_also: ["Gen Common Operators", "Gen Overview", "gen~ Operators", "mcs.gen~", "mc.gen~", "jit.gen", "jit.pix"]
---
# mc.gen~

Generate native audio signal processing routines (multichannel)

## Description

The [gen~](https://docs.cycling74.com/reference/gen~) object turns an embedded Gen patcher into signal processing routines of optimized native machine code. The Gen patcher can be built from a wide set of low-level Gen operator objects as well as embedded code expressions.
...
| [mcs.gen~](https://docs.cycling74.com/reference/mcs.gen~) | Generate native audio signal processing routines |

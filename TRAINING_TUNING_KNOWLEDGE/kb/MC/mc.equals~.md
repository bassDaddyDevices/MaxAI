...
type: mc
name: "mc.equals~"
summary: "Is equal to, comparison of two signals (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.equals~/"
package: "MC"
see_also: ["<~", "<=~", ">~", ">=~", "!=~", "change~", "edge~"]
---
# mc.equals~

Is equal to, comparison of two signals (multichannel)

## Description

[==~](https://docs.cycling74.com/reference/equals~) outputs a 1 signal when the left input is equal to the right input and a 0 when it is not equal to the right input. The right input can be a signal or a float.

...
type: mc
name: "mc.retune~"
summary: "Ztx-based pitch detection and pitchshift (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.retune~/"
package: "MC"
see_also: ["fbinshift~", "freqshift~", "fzero~", "gizmo~", "hilbert~", "pitchshift~"]
---
# mc.retune~

Ztx-based pitch detection and pitchshift (multichannel)

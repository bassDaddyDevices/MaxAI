...
type: mc
name: "mc.bitnot~"
summary: "Bitwise inversion of a floating point signal (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.bitnot~/"
package: "MC"
see_also: ["bitshift~", "bitor~", "bitxor~", "bitand~"]
---
# mc.bitnot~

Bitwise inversion of a floating point signal (multichannel)

...
type: mc
name: "mc.ftom~"
summary: "Convert frequency to MIDI note numbers at signal-rate (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.ftom~/"
package: "MC"
see_also: ["expr", "ftom", "mtof", "mtof~"]
---
# mc.ftom~
...
Use [ftom~](https://docs.cycling74.com/reference/ftom~) to convert frequency to MIDI note numbers at signal rate

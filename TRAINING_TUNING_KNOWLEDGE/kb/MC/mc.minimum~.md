...
type: mc
name: "mc.minimum~"
summary: "Compare two signals, output the minimum  (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.minimum~/"
package: "MC"
see_also: ["<=~", ">~", ">=~", "==~", "!=~", "maximum~"]
---
# mc.minimum~

Compare two signals, output the minimum (multichannel)

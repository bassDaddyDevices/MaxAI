...
type: mc
name: "mc.cartopol~"
summary: "Signal Cartesian to Polar coordinate conversion  (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.cartopol~/"
package: "MC"
see_also: ["cartopol", "fft~", "fftin~", "fftinfo~", "fftout~", "frameaccum~", "framedelta~", "ifft~", "pfft~", "poltocar", "poltocar~", "vectral~"]
---
# mc.cartopol~

Signal Cartesian to Polar coordinate conversion (multichannel)

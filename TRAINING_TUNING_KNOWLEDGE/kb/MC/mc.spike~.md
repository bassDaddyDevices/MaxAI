...
type: mc
name: "mc.spike~"
summary: "Report intervals of zero to non-zero transitions  (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.spike~/"
package: "MC"
see_also: ["change~", "edge~", "zerox~"]
---
# mc.spike~

Report intervals of zero to non-zero transitions (multichannel)

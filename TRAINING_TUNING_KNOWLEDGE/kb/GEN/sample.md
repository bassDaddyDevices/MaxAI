...
type: gen
name: "sample"
summary: "Linear interpolated multi-channel lookup of a data/buffer object"
signal: false
url: "https://docs.cycling74.com/reference/gen_dsp_sample/"
package: "Gen"
see_also: ["buffer", "channels", "cycle", "data", "dim", "lookup", "nearest", "peek", "poke", "sample", "splat", "wave"]
---
# sample

Linear interpolated multi-channel lookup of a data/buffer object

## Description

Linear interpolated multi-channel lookup of a data/buffer object. The first argument should be a name of a data or buffer object in the gen patcher. The second argument specifies the number of output channels. The last inlet specifies a channel offset (default 0).

...
type: msp
name: "index~"
summary: "Read from a  buffer~ with no interpolation"
signal: true
url: "https://docs.cycling74.com/reference/index~/"
package: "MSP"
see_also: ["buffer~", "buffir~", "count~", "fft~"]
---
# index~

Read from a [buffer~](https://docs.cycling74.com/reference/buffer~) with no interpolation

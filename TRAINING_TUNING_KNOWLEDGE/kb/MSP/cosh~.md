...
type: msp
name: "cosh~"
summary: "Signal hyperbolic cosine function"
signal: true
url: "https://docs.cycling74.com/reference/cosh~/"
package: "MSP"
see_also: ["acos~", "acosh~", "asin~", "asinh~", "atan~", "atanh~", "atan2~", "cos~", "cosx~", "sinh~", "sinx~", "tanh~", "tanx~"]
---
# cosh~
...
Use the [cosh~](https://docs.cycling74.com/reference/cosh~) object to calculate and output a signal that is the hyperbolic cosine function of each sample of the input signal.
...
Input to hyperbolic cosine function

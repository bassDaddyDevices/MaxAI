---
type: cookbook
name: "Windowing an audio signal"
summary: "In signal processing, a \"window\" is a function (shape) that is nonzero for some period of time, and zero before and after that period."
chapter: "MSP"
keywords: ["buffer~", "dbtoa", "expr", "ezdac~", "float", "info~", "line~", "loadbang", "pack", "peek~", "play~", "sampstoms~", "scope~", "select", "selector~", "sfplay~", "trapezoid~", "triangle~", "uzi", "*~", "AIFF file", "WAVE file"]
objects: ["*~", "0.", "buffer~", "dbtoa", "expr", "ezdac~", "f", "info~", "line~", "loadbang", "pack", "peek~", "play~", "sampstoms~", "scope~", "sel", "selector~", "sfplay~", "slider", "trapezoid~", "triangle~", "uzi"]
patch: "/Volumes/DEV/Ableton Projects/MAX-LEARNOTRON/max-cookbook-archive/patches/windowing.maxpat"
image: "/Volumes/DEV/Ableton Projects/MAX-LEARNOTRON/max-cookbook-archive/images/windowing.png"
---
...
`*~` ×5, `expr` ×4, `scope~` ×3, `line~` ×2, `uzi` ×2, `peek~` ×2, `loadbang` ×2, `slider`, `0.`, `sel`, `dbtoa`, `pack`, `selector~`, `sfplay~`, `ezdac~`, `sampstoms~`, `buffer~`, `info~`, `triangle~`, `trapezoid~`, `play~`, `f`

*Patch contains 63 boxes, 62 connections.*

## Files

- Patch: `/Volumes/DEV/Ableton Projects/MAX-LEARNOTRON/max-cookbook-archive/patches/windowing.maxpat`
- Signal flow diagram: `/Volumes/DEV/Ableton Projects/MAX-LEARNOTRON/max-cookbook-archive/images/windowing.png`

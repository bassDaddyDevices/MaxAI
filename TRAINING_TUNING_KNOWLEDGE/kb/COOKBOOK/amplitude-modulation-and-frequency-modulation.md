---
type: cookbook
name: "Amplitude modulation and frequency modulation"
summary: "In electronic music parlance, the word \"modulation\" means change, specifically the continuous or cyclical change caused by using one signal to control another."
chapter: "MSP"
keywords: ["cycle~", "modulation", "vibrato", "tremolo", "frequency modulation", "amplitude modulation"]
objects: ["*~", "+~", "1", "cycle~", "dac~", "deferlow", "gain~", "line~", "loadbang", "number~", "pack", "preset", "scope~"]
patch: "/Volumes/DEV/Ableton Projects/MAX-LEARNOTRON/max-cookbook-archive/patches/amfm1.maxpat"
image: "/Volumes/DEV/Ableton Projects/MAX-LEARNOTRON/max-cookbook-archive/images/amfm1_0.png"
---

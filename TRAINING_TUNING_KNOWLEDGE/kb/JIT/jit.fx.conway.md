...
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.conway/"
package: "Jitter FX"
...
Performs Conway's Game of Life (a cellular automata function) on incoming textures.
...
Luminance threshold amount (default = 0.5). If a pixel's luminance (brightness) is greater than amt, it is considered active (set to 1.0); otherwise, it is considered inactive (0.0).

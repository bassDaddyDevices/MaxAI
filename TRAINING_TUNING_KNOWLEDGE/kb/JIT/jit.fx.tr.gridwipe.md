---
type: jitter
name: "jit.fx.tr.gridwipe"
summary: "Gridwipe transition"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.tr.gridwipe/"
package: "Jitter FX"
...
[jit.fx.tr.gridwipe](https://docs.cycling74.com/reference/jit.fx.tr.gridwipe) transitions two textures by dissolving the first one with an animated grid mask.
...
Fade the edges of the grid mask (default = 0 0).
...
Control the grid mask position (default = 0 0).

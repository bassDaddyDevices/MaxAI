---
type: jitter
name: "jit.fx.tr.rotfade"
summary: "Rotfade transition"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.tr.rotfade/"
package: "Jitter FX"
...
[jit.fx.tr.rotfade](https://docs.cycling74.com/reference/jit.fx.tr.rotfade) performs a rotation based image transition from the first to the second provided texture. Motionblur can be optionally enabled.
...
The amount the images will rotate in degrees (default = 45).

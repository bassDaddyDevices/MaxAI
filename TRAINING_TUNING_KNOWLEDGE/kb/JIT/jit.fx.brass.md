...
type: jitter
name: "jit.fx.brass"
summary: "Emboss incoming texture"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.brass/"
package: "Jitter FX"
...
Emboss incoming texture

## Description

Provides a quick and dirty embossing effect on an input texture. You can specify the width of the emboss effect and apply an overall tint to the output texture.
...
### offset[4 floats]: 0.5 0.5 0.5 0.5

Amount of tinting in the RGBA format(default = 0. 0. 0. 0.).

### width[float]: 1

Emboss width (default = 1). Defines the distance from the current pixel at which neighboring texels are sampled. A larger width increases the spatial spread of the effect.

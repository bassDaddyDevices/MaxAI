...
type: jitter
name: "jit.ui.number"
summary: "An interactive  flonum in the rendering window"
signal: false
url: "https://docs.cycling74.com/reference/jit.ui.number/"
package: "Jitter Tools"
see_also: ["jit.ui.canvas", "jit.ui.button", "jit.ui.toggle", "jit.ui.slider", "jit.ui.group"]
---
# jit.ui.number

An interactive [flonum](https://docs.cycling74.com/reference/flonum) in the rendering window
...
### number\_value\_color[4 floats]

UI number value color (default = 1. 1. 1. 1.)

### number\_value\_fontsize[float]

UI number value font size

### number\_value\_offset[2 ints]
...
### triangle\_color[4 floats]

UI number triangle color (default = 0.2 0.2 0.2 1.)

### triangle\_offset[2 ints]

---
type: jitter
name: "jit.fx.tr.zoomfade"
summary: "Zoomfade between two textures"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.tr.zoomfade/"
package: "Jitter FX"
...
Zoomfade between two textures

## Description

[jit.fx.tr.zoomfade](https://docs.cycling74.com/reference/jit.fx.tr.zoomfade) performs a zoom and fade based transition between the input textures. Motionblur can be optionally enabled.
...
Toggle motionblur (default = 1).

### zoom[float]: 1

Zoom factor to apply when transitioning (default = 1).

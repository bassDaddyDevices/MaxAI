...
type: jitter
name: "jit.ui.button"
summary: "An interactive button in the rendering window"
signal: false
url: "https://docs.cycling74.com/reference/jit.ui.button/"
package: "Jitter Tools"
see_also: ["jit.ui.canvas", "jit.ui.slider", "jit.ui.toggle", "jit.ui.number", "jit.ui.group"]
---
# jit.ui.button

An interactive button in the rendering window
...
Animate button mouse click (default = 1)
When the flag is set, the button will appear smaller when clicked.
...
### color\_button\_pressed[4 floats]

Color of UI button when pressed (default = 0.8 0.8 0.8 1.)
...
### read\_image\_button\_pressed[symbol]

Load an image and display it on background of UI object when the button is pressed (default = none)
The argument to this attribute is the path of the image.
...
### texture\_button\_pressed[symbol]

Name of texture to be applied to the background of the UI object when button is pressed (default = none)

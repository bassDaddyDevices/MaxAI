---
type: jitter
name: "jit.fx.bitcrush"
summary: "Bitcrushes an incoming texture"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.bitcrush/"
package: "Jitter FX"
...
Bitcrushes an incoming texture

## Description

Applies bitcrushing to an incoming texture and reduces its color depth.
...
The number of distinct color shades (default = 256).
...
Select different dithering algorithms (default = none). These are used to soften the harsh edges of color quantization and reduce banding, resulting in a smoother image.
 Possible dithering algorithms:
 0 = Uniform
 1 = Interleaved
 Vlachos (col)
 Vlachos TrianglePDF

...
type: jitter
name: "jit.gl.isosurf"
summary: "Generate a GL based surface extraction"
signal: false
url: "https://docs.cycling74.com/reference/jit.gl.isosurf/"
package: "Jitter"
see_also: ["jit.gl.graph", "jit.gl.gridshape", "jit.gl.handle", "jit.gl.mesh", "jit.gl.model", "jit.gl.nurbs", "jit.gl.plato", "jit.gl.render", "jit.gl.shader", "jit.gl.sketch", "jit.gl.slab", "jit.gl.text2d", "jit.gl.text3d", "jit.gl.texture", "jit.gl.videoplane", "jit.gl.volume"]
---
# jit.gl.isosurf
...
The number of triangles in the surface mesh. This attribute is useful when drawing with matrixoutput enabled. See the
[jit.gl.isosurf-matrixoutput](openfilelink)

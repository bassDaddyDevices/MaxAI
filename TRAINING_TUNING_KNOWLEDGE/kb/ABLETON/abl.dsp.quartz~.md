...
type: ableton
name: "abl.dsp.quartz~"
summary: "Quartz reverb"
signal: true
url: "https://docs.cycling74.com/reference/abl.dsp.quartz~/"
package: "Ableton DSP"
see_also: ["abl.device.reverb~", "abl.dsp.darkhall~", "abl.dsp.prism~", "abl.dsp.shimmer~", "abl.dsp.tides~"]
---
# abl.dsp.quartz~
...
Algorithmic Quartz reverb from Live's Hybrid Reverb device.
...
Controls the virtual distance of reflections. Lower values place them closer to the listener
and increase their density while higher values place them farther away and increase the time between
echoes. [0., 1.]
...
Controls the amount of low frequency filtering within the reverb algorithm. Higher values
result in brighter reverberation sounds. [0., 1.]

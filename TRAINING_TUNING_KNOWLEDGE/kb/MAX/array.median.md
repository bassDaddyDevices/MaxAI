...
type: max
name: "array.median"
summary: "Calculate the median of the numerical elements of an array"
signal: false
url: "https://docs.cycling74.com/reference/array.median/"
package: "Max"
see_also: ["array", "array.min", "array.max", "array.mean", "array.mode", "array.stddev", "zl.median"]
---
# array.median
...
Determines how the [array.median](https://docs.cycling74.com/reference/array.median) object behaves When the incoming array has an even number of entries.
...
Output the average of the two median values.

1 = 'Low'
(
Lower value
)
Output the lesser of the two median values.

2 = 'High'
(
Higher value
)
Output the greater of the two median values.

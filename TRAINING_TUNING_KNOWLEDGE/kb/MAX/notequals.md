...
type: max
name: "notequals"
summary: "Compare numbers for not-equal-to condition"
signal: false
url: "https://docs.cycling74.com/reference/notequals/"
package: "Max"
...
### initial-comparison-value[int or float] optional
...
In left inlet: Performs the comparison with the numbers currently stored. If there is no argument, [!=](https://docs.cycling74.com/reference/notequals) initially holds  0  for comparison.

### int

In left inlet: The number is compared with the number in the right inlet. If the two numbers are not equal, [!=](https://docs.cycling74.com/reference/notequals) outputs  1 . If they are equal [!=](https://docs.cycling74.com/reference/notequals) outputs  0 .
...
Converted to  int  before comparison, unless [!=](https://docs.cycling74.com/reference/notequals) has a float argument.

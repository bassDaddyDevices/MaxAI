...
signal: false
url: "https://docs.cycling74.com/reference/node.script/"
package: "Node for Max"
see_also: ["node.codebox", "v8", "v8ui", "v8.codebox"]
---
# node.script
...
Control a local Node.js process from Max. Messages preceded by  script
...
| Name | Description |
| --- | --- |
| [node.codebox](https://docs.cycling74.com/reference/node.codebox) |  |

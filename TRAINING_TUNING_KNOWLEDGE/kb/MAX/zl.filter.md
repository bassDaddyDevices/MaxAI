...
signal: false
url: "https://docs.cycling74.com/reference/zl.filter/"
package: "Max"
see_also: ["zl", "zl.change", "zl.compare", "zl.delace", "zl.ecils", "zl.group", "zl.indexmap", "zl.iter", "zl.join", "zl.lace", "zl.len", "zl.lookup", "zl.median", "zl.mth", "zl.nth", "zl.queue", "zl.reg", "zl.rev", "zl.rot", "zl.scramble", "zl.sect", "zl.slice", "zl.sort", "zl.stack", "zl.stream", "zl.sub", "zl.sum", "zl.swap", "zl.thin", "zl.union", "zl.unique"]
---
# zl.filter

...
type: gen
name: "t60time"
summary: "Return a given t60 time (in samples) for a given multiplication factor"
signal: false
url: "https://docs.cycling74.com/reference/gen_dsp_t60time/"
package: "Gen"
see_also: ["atodb", "dbtoa", "ftom", "mstosamps", "mtof", "sampstoms", "t60", "t60time"]
---
# t60time

Return a given t60 time (in samples) for a given multiplication factor

## Description

Estimates the decay time (in samples) of a given decay factor. That is, given a multiplier X, returns a number T such that, after T multiplications of a signal by X, that signal would be attenuated by 60 decibels. It is the dual of the t60 object.

## Constructors

- { arguments={}, inlets={multiplier} }

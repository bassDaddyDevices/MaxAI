...
type: gen
name: "t60"
summary: "Return multiplication factor for a given t60 time (in samples)"
signal: false
url: "https://docs.cycling74.com/reference/gen_dsp_t60/"
package: "Gen"
see_also: ["atodb", "dbtoa", "ftom", "mstosamps", "mtof", "sampstoms", "t60", "t60time"]
---
# t60

Return multiplication factor for a given t60 time (in samples)
...
- { arguments={}, inlets={time} }

## Inlets

### time[float]

time (samples) to decay by 60 dB

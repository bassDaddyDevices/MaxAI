...
type: gen
name: "channels"
summary: "The number of channels of a data/buffer object"
signal: false
url: "https://docs.cycling74.com/reference/gen_dsp_channels/"
package: "Gen"
see_also: ["buffer", "channels", "cycle", "data", "dim", "lookup", "nearest", "peek", "poke", "sample", "splat", "wave"]
---
# channels

The number of channels of a data/buffer object

## Description

The number of channels of a data/buffer object. The first argument should be a name of a data or buffer object in the gen patcher.

...
type: jitter
name: "jit.fx.grain"
summary: "Simulate analog film grain"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.grain/"
package: "Jitter FX"
...
The amount of noise on the output texture (default = 0.5)

### color\_tint[float]

Color tint amount (default = 0.6). Use color\_tint to adjust the blend between the red, green, and blue noise components, controlling the color variation of the grain. It determines how much the green and blue noise channels deviate from the red noise channel, adding more color diversity to the grain effect.

### colored[int]

Determines if noise is tinted (default = 1)
...
Size of noise grains (default = 3.)

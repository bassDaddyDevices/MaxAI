...
type: jitter
name: "jit.fx.camera"
summary: "Simulates a virtual camera"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.camera/"
package: "Jitter FX"
...
Simulates a virtual camera

## Description

Simulates a virtual camera for image panning, zooming, and rotation, with optional motion blur.
...
Intensity of motion blur caused by camera movement (default = 1).

### boundmode[0 atoms]

Texture sampling outside image bounds (default = clamp).
Possible values:
...
Target position centered in the output image (default = 0 0).

### tilt[0 floats]

Camera rotation angle along the view axis (default = 0).

### zoom[0 floats]

Magnification factor (default = 0).

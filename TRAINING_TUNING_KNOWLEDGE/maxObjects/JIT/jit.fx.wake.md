...
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.wake/"
package: "Jitter FX"
...
Use the [jit.fx.wake](https://docs.cycling74.com/reference/jit.fx.wake) object to perform video feedback with a convolution stage on textures.
...
The all upper, lower, left, and right convolution kernel values (default = 0.)
...
Feedback level (default = 0.)

### ff[float]: 1

Feed forward level (default = 1)

### gain[float]: 0

Gain level for all colors (default = 0.)

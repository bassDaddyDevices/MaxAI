---
type: jitter
name: "jit.fx.pixelsorting"
summary: "Apply real-time pixel sorting to incoming texture"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.pixelsorting/"
package: "Jitter FX"
...
Apply real-time pixel sorting to incoming texture
...
The axis along which pixel sorting occurs (default = horizontal)
Possible values:
...
Invert threshold selection (default = 0). When the invert flag is set, the pixels with the red channel value under the threshold value are selected for sorting.

### max\_iterations[int]: 1000

Max iterations of the algorithm (default = 1000)

### sortdir[0 atoms]

Pixel sorting direction (default = ascending). Other possible value is descending.
Possible values:
...
Color threshold (default = 0.5). Determines which pixels are eligible for sorting based on their red channel value.

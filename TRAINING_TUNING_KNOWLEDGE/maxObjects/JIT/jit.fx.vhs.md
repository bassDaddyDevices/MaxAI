...
type: jitter
name: "jit.fx.vhs"
summary: "VHS playback simulation effect"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.vhs/"
package: "Jitter FX"
...
VHS playback simulation effect

## Description

Simulates the look of VHS playback, adding analog distortion and instability.
...
Amount of color bleeding and smearing (default = 1).

### wiggle[float]

Intensity of random image wobble (default = 0.3)

### wiggle\_speed[float]

Speed of the wobbling motion (default = 25).

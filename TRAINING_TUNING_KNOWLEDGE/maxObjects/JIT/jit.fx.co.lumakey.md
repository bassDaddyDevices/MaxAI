---
type: jitter
name: "jit.fx.co.lumakey"
summary: "Luma key blending mode"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.co.lumakey/"
package: "Jitter FX"
...
Luma key blending mode

## Description

Uses a secondary input for luminance keying support.
...
Desired luminance coefficients.

### mode[float]

Mask mode (if 1, result mask only)

### tol[float]

Tolerance for luminance keying.

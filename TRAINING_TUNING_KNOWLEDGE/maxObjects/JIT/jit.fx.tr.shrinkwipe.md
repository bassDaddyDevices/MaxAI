---
type: jitter
name: "jit.fx.tr.shrinkwipe"
summary: "Shrinkwipe transition"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.tr.shrinkwipe/"
package: "Jitter FX"
...
---
# jit.fx.tr.shrinkwipe

Shrinkwipe transition

## Description

[jit.fx.tr.shrinkwipe](https://docs.cycling74.com/reference/jit.fx.tr.shrinkwipe) transitions two textures by dissolving the first one with an animated grid mask.
...
Smoothes the edges of the grid mask (default = 0 0).

### invert[float]

Factor to invert the grid mask (default = 0).

### scale[2 floats]

Control the grid cell count (default = 1 1).

### wipe[2 floats]

Control the grid wipe factor (default = 0 0). If either one of the axis reaches 1, the second texture is fully visible.

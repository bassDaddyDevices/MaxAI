...
type: jitter
name: "jit.gl.lua"
summary: "Script OpenGL and Jitter with Lua."
signal: false
url: "https://docs.cycling74.com/reference/jit.gl.lua/"
package: "Jitter"
see_also: ["jit.gl.lua Color Bindings", "jit.gl.lua OpenGL Bindings", "jit.gl.lua Overview", "jit.gl.lua Vector Math", "js", "jit.gl.sketch"]
---
# jit.gl.lua
...
[jit.gl.lua](https://docs.cycling74.com/reference/jit.gl.lua) provides and interface to both OpenGL and Jitter through the Lua scripting language. [jit.gl.lua](https://docs.cycling74.com/reference/jit.gl.lua) is similar to the [js](https://docs.cycling74.com/reference/js) object for JavaScript.
...
Send an int to the msg\_int function.

### float

Send an int to the msg\_float function.

### list

Send an int to the msg\_list function.
...
When the closebang message is triggered, [jit.gl.lua](https://docs.cycling74.com/reference/jit.gl.lua) will look for a closebang() function in the currently running Lua script and call it.
...
When the loadbang message is triggered, [jit.gl.lua](https://docs.cycling74.com/reference/jit.gl.lua) will look for a loadbang() function in the currently running Lua script and call it.
...
| Name | Description |
| --- | --- |
| [jit.gl.lua Color Bindings](https://docs.cycling74.com/userguide/lua/jit_gl_lua_color_bindings) | jit.gl.lua Color Bindings |
| [jit.gl.lua OpenGL Bindings](https://docs.cycling74.com/userguide/lua/jit_gl_lua_opengl_bindings) | jit.gl.lua OpenGL Bindings |
| [jit.gl.lua Overview](https://docs.cycling74.com/userguide/lua/jit_gl_lua_overview) | jit.gl.lua Overview |
| [jit.gl.lua Vector Math](https://docs.cycling74.com/userguide/lua/jit_gl_lua_vector_math) | jit.gl.lua Vector Math |

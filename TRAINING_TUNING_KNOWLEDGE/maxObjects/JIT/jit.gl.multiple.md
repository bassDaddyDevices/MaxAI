---
type: jitter
name: "jit.gl.multiple"
summary: "Create multiple object instances"
signal: false
url: "https://docs.cycling74.com/reference/jit.gl.multiple/"
package: "Jitter"
see_also: ["jit.gl.gridshape", "jit.gl.model", "jit.gl.nurbs", "jit.gl.plato", "jit.gl.text", "jit.gl.mesh", "jit.gl.node", "jit.gl.texture", "jit.gl.shader", "jit.gl.material", "jit.gl.pbr", "jit.phys.multiple"]
---
# jit.gl.multiple
...
Uses several jit.matrix objects to repeatedly draw an instance of a jit.gl object like [jit.gl.mesh](https://docs.cycling74.com/reference/jit.gl.mesh) or [jit.gl.gridshape](https://docs.cycling74.com/reference/jit.gl.gridshape). It attaches to a named instance of a jit.gl (OB3D) object provided by the targetname attribute.

#### Discussion

Parameters that can be set include position, rotate, rotatexyz, scale, color, and texture. All of these parameters take float32 matrices except texture which takes a char specifying the texture from a list. Parameter matrices can be of differing dim sizes, and will wrap to the dimensions of the matrix specified by the dimparam attribute.

For transformation attributes (position, rotate, rotatexyz, and scale), the order parameters are listed in the glparams attribute determines the order transformations are applied. The standard jit.gl transformation order is position, rotate, scale.
...
The list of OB3D attributes corresponding to object inlets that are modifiable by passing in a matrix. Valid attributes are position, rotate (angle-axis), rotatexyz, scale, color, texture.

### targetmode[int]

Flag for draw mode. 1 = draw\_raw, 0 = draw.

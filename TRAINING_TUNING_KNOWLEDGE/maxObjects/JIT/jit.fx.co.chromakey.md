---
type: jitter
name: "jit.fx.co.chromakey"
summary: "Chromatic distance based keying"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.co.chromakey/"
package: "Jitter FX"
...
Chroma keying support using target colors.

## Attributes

### binary[float]

Mix with second source (if 0, just gen alpha channel).
...
RGBA target color for chroma key color.
...
Range over which inputs should be blended.

### invert[float]

Inverts blending scale if set to 1.

### mode[float]

Switch between blend or masking mode.

### tol[float]

Tolerance for color distance in blending calculation.

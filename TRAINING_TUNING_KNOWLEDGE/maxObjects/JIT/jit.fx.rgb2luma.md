---
type: jitter
name: "jit.fx.rgb2luma"
summary: "Converts RGB to monochrome (luminance)"
signal: false
url: "https://docs.cycling74.com/reference/jit.fx.rgb2luma/"
package: "Jitter FX"
...
[jit.fx.rgb2luma](https://docs.cycling74.com/reference/jit.fx.rgb2luma) converts a 4-plane char ARGB (alpha, red, green, blue) texture into a 1-plane char monochrome texture containing the luminosity of the original texture using the equation L = (.299 \* R value) + (.587 \* G value) + (.114 \* B value).

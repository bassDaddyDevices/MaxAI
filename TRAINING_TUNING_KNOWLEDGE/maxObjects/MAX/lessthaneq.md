...
type: max
name: "lessthaneq"
summary: "Compare numbers as less than or equal to"
signal: false
...
In left inlet: Performs the comparison with the numbers currently stored. If there is no argument, [<=](https://docs.cycling74.com/reference/lessthaneq) initially holds  0  for comparison.

### int

In left inlet: If the number is less than or equal to the number in the right inlet, [<=](https://docs.cycling74.com/reference/lessthaneq) outputs  1 . Otherwise, [<=](https://docs.cycling74.com/reference/lessthaneq) outputs  0 .
...
Converted to  int  before comparison, unless [<=](https://docs.cycling74.com/reference/lessthaneq) has a float argument.

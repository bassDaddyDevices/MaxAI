...
type: msp
name: "oscbank~"
summary: "Non-interpolating oscillator bank"
signal: true
url: "https://docs.cycling74.com/reference/oscbank~/"
package: "MSP"
see_also: ["ioscbank~"]
---
# oscbank~
...
[oscbank~](https://docs.cycling74.com/reference/oscbank~) is a non-interpolating oscillator bank with signal inputs to set oscillator frequency and magnitude.
...
The size, in samples, of the sinewave lookup table used by the [oscbank~](https://docs.cycling74.com/reference/oscbank~) object. The default is 4096. Since [oscbank~](https://docs.cycling74.com/reference/oscbank~) uses uninterpolated oscillators, you can choose to use a sinetable of larger size at the expense of CPU.

Note: There is only one wavetable for all oscillators in a given [oscbank~](https://docs.cycling74.com/reference/oscbank~) object,
...
In left inlet: The word  copybuf , followed by a symbol that specifies a buffer, copies samples from the buffer into the [oscbank~](https://docs.cycling74.com/reference/oscbank~) object's internal wavetable. The number of samples is set using the  tabpoints  message. An optional second integer argument specifies the position in the buffer at which samples are loaded (offset).
...
The word  set , followed by pairs of floating-point values, sets the frequency and amplitude of an oscillator in the oscillator bank. A list of n pairs will set the first n oscillators in the [oscbank~](https://docs.cycling74.com/reference/oscbank~) object and zero the amplitude of all others.

Arguments:

- frequency-amplitude-pairs (floats)
  [list]
...
The word  tabpoints , followed by a number, sets the number of wavetable points (samples) in the [oscbank~](https://docs.cycling74.com/reference/oscbank~) object's internal wavetable. The default is 4096. The number of wavetable points should be a power or two between 2
and 2
16
. Any other value will be rounded to the nearest power of two.

Arguments:

- lookup-table-size (samples)
  [int]
...
| Name | Description |
| --- | --- |
| [ioscbank~](https://docs.cycling74.com/reference/ioscbank~) | Interpolating oscillator bank |

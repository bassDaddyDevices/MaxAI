...
type: mc
name: "mc.bitshift~"
summary: "Bit shifting for floating point signals  (multichannel)"
signal: true
url: "https://docs.cycling74.com/reference/mc.bitshift~/"
package: "MC"
see_also: ["bitand~", "bitor~", "bitxor~", "bitnot~"]
---
# mc.bitshift~

Bit shifting for floating point signals (multichannel)

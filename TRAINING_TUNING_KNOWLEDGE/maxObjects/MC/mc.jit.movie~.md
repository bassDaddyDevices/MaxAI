...
type: mc
name: "mc.jit.movie~"
summary: "Play a movie file with an audio track"
signal: true
url: "https://docs.cycling74.com/reference/mc.jit.movie~/"
package: "VIDDLL"
see_also: ["jit.movie", "jit.playlist", "jit.grab", "jit.record", "jit.world", "jit.gl.texture"]
---
# mc.jit.movie~
...
Use [jit.movie~](https://docs.cycling74.com/reference/jit.movie~) for playing movie files and routing the audio track into MSP.

#### Discussion

The [jit.movie~](https://docs.cycling74.com/reference/jit.movie~) object loads movie files using the viddll engine.
...
| [jit.record](https://docs.cycling74.com/reference/jit.viddll.record) | Record a movie file |
